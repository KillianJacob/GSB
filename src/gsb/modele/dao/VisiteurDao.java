...
public class VisiteurDao {
	public static Visiteur rechercher(String matriculeVisiteur) {
		...
		try {
			/*
			 * (String matricule, String nom, String prenom, String login, String mdp,
			 * String adresse, Localite uneLocalite, String telephone, Date dateEntree, int
			 * prime, String codeUnite, String nomUnite) (`MATRICULE`, `NOM`, `PRENOM`,
			 * `LOGIN`, `MDP`, `ADRESSE`, `CODEPOSTAL`, `DATEENTREE`, `CODEUNIT`, `NOMUNIT`)
			 */
	...
	public static int AjouterVisiteur(Visiteur visiteur) {
		...
		String requette = "INSERT INTO `visiteur` (`MATRICULE`, `NOM`, `PRENOM`, `LOGIN`, `MDP`, `ADRESSE`, `CODEPOSTAL`, `DATEENTREE`, `CODEUNIT`, `NOMUNIT`) VALUES ('"
				+ visiteur.getMatricule() + "', '" + visiteur.getNom() + "', '" + visiteur.getPrenom() + "', '"
				+ visiteur.getLogin() + "', '" + visiteur.getMdp() + "', '" + visiteur.getAdresse() + "', '" + "code"
				+ "', '" + visiteur.getDateEntree() + "', '" + visiteur.getCodeUnite() + "', '" + visiteur.getNomUnite()
				+ "');";
